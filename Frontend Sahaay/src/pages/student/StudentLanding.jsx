    ...
    <div className={styles.hero}>
      ...
      <header className={styles.header}>
        <div className={styles.logo}>
          ...
          <div>
            <div className={styles.brand}>Sahaay</div>
            <div className={styles.tagline}>Your mental health Companion</div>
          </div>
        </div>
        <nav className={styles.nav}>
          <a href="#features" className={styles.navLink}>Features</a>
          <a href="#about" className={styles.navLink}>About Sahaay</a>
        ...
        <section id="features" className={styles.infoSection}>
          <div className={styles.infoGrid}>
            ...
            <div className={styles.featuresCard}>
              <h2 className={styles.cardTitle}>Why Choose Sahaay?</h2>
            ...
            <div id="about" className={styles.aboutCard}>
              <h2 className={styles.cardTitle}>About Sahaay</h2>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerLinks}>
            ...
            <div className={styles.footerColumn}>
              <h4>Contact</h4>
              <a href="#">support@sahaay.edu</a>
              <a href="#">crisis@sahaay.edu</a>
              <a href="#">+1 (800) 123-4567</a>
            </div>
          </div>
        </div>
        <div className={styles.footerBottom}>
          <p>&copy; 2024 Sahaay. All rights reserved. Your mental health matters.</p>
        </div>
      </footer>
    </div>
  )
